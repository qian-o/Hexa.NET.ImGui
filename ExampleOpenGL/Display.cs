...
internal readonly record struct Display
{
    ...
    {
        return $"Display {Index}: Name: {Name}, MainPosition: {MainPosition}, MainSize: {MainSize}, WorkPosition: {WorkPosition}, WorkSize: {WorkSize}, DpiScale: {DpiScale}";
    }
}
